...
export default function Contact() {
  ...
  return (
    <div className="w-full bg-[#fce8eb] mt-[115px]"> {/* Updated background color */}
    <div className="max-w-[2000px] mx-auto p-4">
      {/* Hero Section */}
      <div className="relative py-16 bg-white rounded-lg mb-12"> {/* Kept the inner section white for contrast */}
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        {/* Contact Form */}
        <div className="bg-white p-8 rounded-lg shadow-md"> {/* Kept the form section white for contrast */}
